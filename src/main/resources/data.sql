...
INSERT INTO category (name, create_date)
...
-- 브랜드 데이터 삽입 (A부터 I까지)
INSERT INTO brand (name, create_date)
...
VALUES ((SELECT id FROM brand WHERE name = 'A'),
...
-- B 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'B'),
        (SELECT id FROM category WHERE name = '상의'),
        10500,
        CURRENT_TIMESTAMP);
...
-- C 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'C'),
        (SELECT id FROM category WHERE name = '상의'),
        10000,
        CURRENT_TIMESTAMP);
...
-- D 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'D'),
        (SELECT id FROM category WHERE name = '상의'),
        10100,
        CURRENT_TIMESTAMP);
...
-- E 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'E'),
        (SELECT id FROM category WHERE name = '상의'),
        10700,
        CURRENT_TIMESTAMP);
...
-- F 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'F'),
        (SELECT id FROM category WHERE name = '상의'),
        11200,
        CURRENT_TIMESTAMP);
...
-- G 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'G'),
        (SELECT id FROM category WHERE name = '상의'),
        10500,
        CURRENT_TIMESTAMP);
...
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'H'),
        (SELECT id FROM category WHERE name = '상의'),
        10800,
        CURRENT_TIMESTAMP);
...
-- I 브랜드 제품
INSERT INTO product (brand_id, category_id, price, create_date)
VALUES ((SELECT id FROM brand WHERE name = 'I'),
        (SELECT id FROM category WHERE name = '상의'),
        11400,
        CURRENT_TIMESTAMP);
